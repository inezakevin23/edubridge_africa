...
export default function SolutionDetailPage() {
  ...
  const author = submission?.submitter?.first_name
    ? `${submission.submitter.first_name} ${submission.submitter.last_name || ""}`.trim()
    : submission?.submitter?.username ||
      submission?.company?.company_name ||
      "Unknown";
        ...
        <div className="mt-7 grid gap-6 lg:grid-cols-[minmax(0,1fr)_300px]">
          <section className="rounded-[18px] border border-white/[0.07] bg-[#131C2E] p-5 shadow-[0_18px_46px_rgba(0,0,0,0.14)] sm:p-7">
            ...
            <div className="mt-7 border-t border-white/[0.07] pt-7">
              ...
              <div className="mt-4 space-y-4 text-[15px] leading-7 text-[#B4C0D1]">
                <p>
                  We analyzed demand concentration, delivery routes, and handoff
                  delays to identify the highest-impact operational changes.
                </p>
                <p>
                  The recommended rollout begins with a focused pilot, followed
                  by measurement against cost, delivery-time, and
